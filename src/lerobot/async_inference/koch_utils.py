...
"""Shared utilities for Koch robot control with FK/IK (both single-arm and bimanual)."""
...
def get_action_features(robot, teleop_processor: RobotProcessorPipeline) -> list[str]:
    """Derive action features for robot using pipeline aggregation.
...
def compute_current_ee(
    ...
    Returns:
        Current EE pose tensor [x, y, z, wx, wy, wz, gripper]
    """
